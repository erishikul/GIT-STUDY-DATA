        ...
        <div class="container-fluid content-top-gap">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/test_Series">test_Series</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <form action="{{route('admin.test_series_edit_post', $data->id)}}" class="w-50" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="sub_category_id" class="form-control input-style"  >
                                        ...
                                        <option value="{{ $SubCat->id }}" @if($SubCat->id == $data->sub_category_id) selected @endif>{{ $SubCat->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                    </div>
                    ...
                    <div class="form-row">
                        {{-- <div class="form-group col-md-3">
                            ...
                            <select class="form-control input-style" name="question_type" id="" required="">
                                <option value="" disabled="" selected="">Select Type of Test</option>
                                <option value="SingleChoice">SingleChoice</option>
                                <option value="MultiChoice" disabled="">MultiChoice</option>
                            </select>
                        </div> --}}
                        {{-- <div class="form-group col-md-3">
                            <label for="inputCity" class="input__label">Select Test Font</label>
                            <select class="form-control input-style" name="language" required="">
                                <option value="" disabled="" selected="">Select Test Language</option>
                                <option value="english">English (Normal Fonts)</option>
                                <option value="hindi">Hindi ( devlys 010 Font )</option>
                            </select>
                        </div> --}}
                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control input-style" name="test_type" id="TypeSelect" required="" onselect="TestType()">
                                <option value="" disabled="" selected="">Select Type of Test</option>
                                <option value="test" @if($data->type == 'test') selected @endif>Paid Test</option>
                                <option value="quiz" @if($data->type == 'quiz') selected @endif>Free Quiz</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <select name="subject_id" class="form-control input-style"  >
                                ...
                                @foreach ($subjects as $sub)
                                    <option value="{{ $sub->id }}" @if($data->subject_id == $sub->id) selected @endif>{{ $sub->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="w-100 row @if($data->type == 'quiz') d-none @endif" id="Onlytest">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="mrp" class="form-control input-style" id="inputEmail4"
                                    placeholder=" ₹ " value="{{$data->mrp}}" required="">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="duration" class="form-control input-style" id="inputEmail4"
                                    placeholder="Enter Time in minutes" value="{{$data->duration}}" required="">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                    ...
                    <button type="submit" class="btn btn-primary btn-style mt-4">Create Test</button>
