                        ...
                        <div class="card card_border p-4">
                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                ...
                                <a href="#" class="btn btn-outline-info" data-bs-toggle="modal"
                                    data-bs-target="#addCategory">Create New Sub Category</a>
                            </div>
                            <hr class="mt-2">
                                ...
                                <tbody>
                                    @foreach ($data->sub_categories as $key => $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('images/cat_img') }}/{{$cat->category_image}}" alt=""
                                                    style="width: 50px;border-radius: 50%;">
                                                {{ $cat->name }}
                                            </td>
                                            <td>
                                                <a href="#" class="btn btn-outline-success" data-bs-toggle="modal"
                                                    data-bs-target="#editCategory" onclick="editCat({{$cat}}, '{{ asset('images/cat_img/'.$cat->category_image) }}')">edit</a>
                                                <a href="{{route('admin.category_delete', $cat->id)}}?subCat" class="btn btn-outline-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('admin.category_create')}}" method="POST" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="modal fade" id="editCategory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('admin.category_edit')}}" method="POST" enctype="multipart/form-data">
                                @csrf
