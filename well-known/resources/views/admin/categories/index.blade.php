                                ...
                                <tbody>
                                    @foreach ($data as $key => $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sub_category', $cat->id) }}"
                                                    class="btn btn-outline-info">Sub Categories</a>
                                                ...
                                                <a href="{{route('admin.category_delete', $cat->id)}}" class="btn btn-outline-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
