                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card card_border p-4">
                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                <h3 class="card__title ">All Playlist </h3>
                                <a href="{{ route('admin.playlist_create') }}" class="btn btn-outline-info">Create New
                                    Playlist</a>
                            </div>
                            <hr class="mt-2">
                                ...
                                <div class="card card_border mt-2 ">
                                    <div class="row p-4" style="max-width: 100%;">
                                        <div class="img col-md-2">
                                            <a href="{{ route('admin.playlist_items', $data->id) }}">
                                        ...
                                        <div class="bio pl-2 col-md-9" style="align-self: center;">
                                           ...
                                           <h6 class="text-info mb-2">Price : ₹{{ $data->price }} || MRP :
                                            ...
                                            <div class="d_block" id="option0"
                                                ...
                                                <form action="{{ route('admin.playlist_status', $data->id) }}"
                                                    method="post">
                                                    @csrf
                                                ...
                                                <a href="{{ route('admin.playlist_edit', $data->id) }}?Category={{ $data->category_id }}"
                                                    class="btn btn-outline-info mt-3 ml-4 mr-4"><i
                                                        class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                                {{-- <a href="?AddToPlaylist&amp;id=941" class="btn btn-outline-info mt-3 mr-4"><i
                                                    class="fa fa-plus-square-o" aria-hidden="true"></i> Add To Playlist</a> --}}
                                                <a onclick="return confirm('Are you sure You Want to Delete this Playlist ?')"
                                                    href="{{ route('admin.playlist_delete', $data->id) }}"
