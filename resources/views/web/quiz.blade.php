    ...
    <section class="arj-breadcrumb">
        <div class="breadcrumb-bg breadcrumb-bg-about py-5">
            <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
                <h2 class="title mt-5 pt-lg-5 pt-sm-3">Online Free Quizz</h2>
                <ul class="breadcrumbs-custom-path pb-sm-5 pb-4 mt-2 text-center mb-md-5">
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li class="active"> / Free Quizz </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container py-lg-5 py-md-4 py-2 row">
                ...
                <div class="col-md-9 row">
                    @foreach ($tests as $test)
                        <div class="col-lg-4 col-md-6 item mt-md-0 mt-5" style="margin: 14px 0px;">
                            <div class="card"
                                style="background-color: #ccfffe7d;box-shadow: rgb(0 0 0 / 14%) 0px 5px 15px;">
                                <div class="card-header p-0 position-relative">
                                    <a href="{{ route('test_start_v2', base64_encode($test->id)) }}" class="zoom d-block"
                                    ...
                                    @endif
                                            {{-- <img class="card-img-bottom d-block"
                                                src="{{ asset('images/test_img/' . $test->thumbnail_url) }}"
                                                alt="Card image cap" style="height: 109px; width: 109px;margin: auto;border-radius:85px;"></a> --}}
                                ...
                                <div class="card-body course-details" style="background-color: #ccfffe7d">
                                    <a href="{{ route('test_start_v2', base64_encode($test->id)) }}"
                                        class="course-desc mt-0" style="height: 50px;">{{ $test->title }}</a>
                                    <hr>
                                    <div class="price-review d-flex justify-content-between mb-1align-items-center mt-2">
                                        <p>Free Quiz</p>
                                        <a href="{{ route('test_start_v2', base64_encode($test->id)) }}"
                                            class="btn btn-outline-primary">Start Now</a>
                                    </div>
                                    <hr>
                                    ...
                                    <div class=" align-items-center d-flex">
                                        {{-- @if (isset($test->category->category_image))
                                            <img src="{{ asset('images/cat_img/' . $test->category->category_image) }}"
                                                alt="" class="img-fluid rounded-circle" style="width: 42px;">
                                        @endif --}}
